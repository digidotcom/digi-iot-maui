...
namespace DigiIoT.Maui.Devices.XBee
{
	...
	public class XBeeBLEDevice : AbstractXBeeDevice, IDigiBLEDevice
	{
		...
		/// <exception cref="InterfaceNotOpenException">If this device connection is not open.</exception>
		/// <exception cref="XBeeLibrary.Core.Exceptions.TimeoutException">If there is a timeout reading the destination address.</exception>
		/// <exception cref="XBeeException">If there is any other XBee related error.</exception>
		...
		/// <exception cref="InterfaceNotOpenException">If this device connection is not open.</exception>
		/// <exception cref="XBeeLibrary.Core.Exceptions.TimeoutException">If there is a timeout setting the destination address.</exception>
		/// <exception cref="XBeeException">If there is any other XBee related error.</exception>
		...
		/// <exception cref="InterfaceNotOpenException">If this device connection is not open.</exception>
		/// <exception cref="XBeeLibrary.Core.Exceptions.TimeoutException">If there is a timeout reading the operating PAN ID.</exception>
		/// <exception cref="XBeeException">If there is any other XBee related error.</exception>
		...
		/// <exception cref="InterfaceNotOpenException">If this device connection is not open.</exception>
		/// <exception cref="XBeeLibrary.Core.Exceptions.TimeoutException">If there is a timeout setting the operating PAN ID.</exception>
		/// <exception cref="XBeeException">If there is any other XBee related error.</exception>
		...
		/// <exception cref="InterfaceNotOpenException">If this device connection is not open.</exception>
		/// <exception cref="XBeeLibrary.Core.Exceptions.TimeoutException">If there is a timeout reading the IO change detect command.</exception>
		/// <exception cref="XBeeException">If there is any other XBee related error.</exception>
		/// <seealso cref="GetDestinationAddress"/>
		/// <seealso cref="SetDestinationAddress(XBee64BitAddress)"/>
		...
		/// <exception cref="InterfaceNotOpenException">If this device connection is not open.</exception>
		/// <exception cref="XBeeLibrary.Core.Exceptions.TimeoutException">If there is a timeout sending the set IO change detect 
		/// command.</exception>
		/// <exception cref="XBeeException">If there is any other XBee related error.</exception>
		/// <seealso cref="GetDestinationAddress"/>
		/// <seealso cref="SetDestinationAddress(XBee64BitAddress)"/>
		...
		/// <exception cref="InterfaceNotOpenException">If this device connection is not open.</exception>
		/// <exception cref="XBeeLibrary.Core.Exceptions.TimeoutException">If there is a timeout reading the IO sampling rate command.</exception>
		/// <exception cref="XBeeException">If there is any other XBee related error.</exception>
		/// <seealso cref="GetDestinationAddress"/>
		/// <seealso cref="SetDestinationAddress(XBee64BitAddress)"/>
		...
		/// <exception cref="InterfaceNotOpenException">If this device connection is not open.</exception>
		/// <exception cref="XBeeLibrary.Core.Exceptions.TimeoutException">If there is a timeout sending the set IO sampling rate 
		/// command.</exception>
		/// <exception cref="XBeeException">If there is any other XBee related error.</exception>
		/// <seealso cref="GetDestinationAddress"/>
		/// <seealso cref="SetDestinationAddress(XBee64BitAddress)"/>
		...
		/// empty value.</exception>
		/// <exception cref="InterfaceNotOpenException">If this device connection is not open.</exception>
		/// <exception cref="XBeeLibrary.Core.Exceptions.TimeoutException">If there is a timeout reading the power level command.</exception>
		/// <exception cref="XBeeException">If there is any other XBee related error.</exception>
		...
		/// <exception cref="InterfaceNotOpenException">If this device connection is not open.</exception>
		/// <exception cref="XBeeLibrary.Core.Exceptions.TimeoutException">If there is a timeout setting the power level command.</exception>
		/// <exception cref="XBeeException">If there is any other XBee related error.</exception>
		...
		/// <exception cref="InvalidOperatingModeException">If the operating mode is different from 
		/// <see cref="OperatingMode.API"/> and <see cref="OperatingMode.API_ESCAPE"/>.</exception>
		/// <exception cref="XBeeLibrary.Core.Exceptions.TimeoutException">If the configured time expires while waiting for the 
