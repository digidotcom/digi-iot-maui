...
namespace BLENetworkConfigurationSample.ViewModels
{
    public class SettingsPageViewModel : DeviceViewModelBase
    {
        ...
        private ObservableCollection<AbstractSetting> settings = new();
        ...
        public bool AreSettingsRefreshing
        {
            ...
            set
            {
                ...
                RaisePropertyChangedEvent(nameof(AreSettingsRefreshing));
            }
        }
		...
		public ObservableCollection<AbstractSetting> Settings
        {
            ...
            {
                settings = value;
                RaisePropertyChangedEvent(nameof(Settings));
            }
        }
