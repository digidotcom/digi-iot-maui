...
namespace BleMicroPythonSample.ViewModels
{
	public class TemperaturePageViewModel : ViewModelBase
	{
		...
		private static readonly Color COLOR_DEFAULT = Color.FromArgb("212121");
		private static readonly Color COLOR_GREEN = Color.FromArgb("84C361");
		...
		public string TemperatureValue
		{
			...
			{
				tempValue = value;
				RaisePropertyChangedEvent(nameof(TemperatureValue));
			}
		}
		...
		public string HumidityValue
		{
			...
			{
				humValue = value;
				RaisePropertyChangedEvent(nameof(HumidityValue));
			}
		}
		...
		public Color ValuesColor
		{
			...
			{
				valuesColor = value;
				RaisePropertyChangedEvent(nameof(ValuesColor));
			}
		}
