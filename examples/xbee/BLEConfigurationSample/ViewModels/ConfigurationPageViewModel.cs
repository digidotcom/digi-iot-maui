...
namespace BLEConfigurationSample.ViewModels
{
	public class ConfigurationPageViewModel : ViewModelBase
	{
		...
		public string ShValue
		{
			...
			{
				shValue = value;
				RaisePropertyChangedEvent(nameof(ShValue));
			}
		}
		...
		public string SlValue
		{
			...
			{
				slValue = value;
				RaisePropertyChangedEvent(nameof(SlValue));
			}
		}
		...
		public string BlValue
		{
			...
			{
				blValue = value;
				RaisePropertyChangedEvent(nameof(BlValue));
			}
		}
		...
		public string NiValue
		{
			...
			{
				niValue = value;
				RaisePropertyChangedEvent(nameof(NiValue));
			}
		}
		...
		public int ApValue
		{
			...
			{
				apValue = value;
				RaisePropertyChangedEvent(nameof(ApValue));
			}
		}
		...
		public int D9Value
		{
			...
			{
				d9Value = value;
				RaisePropertyChangedEvent(nameof(D9Value));
			}
		}
		...
		public string VrValue
		{
			...
			{
				vrValue = value;
				RaisePropertyChangedEvent(nameof(VrValue));
			}
		}
		...
		public string HvValue
		{
			...
			{
				hvValue = value;
				RaisePropertyChangedEvent(nameof(HvValue));
			}
		}
